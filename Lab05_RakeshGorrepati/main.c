...
void goToPause() {
    ...
    //drawChar(SCREENWIDTH/2,SCREENHEIGHT/2,'P',RED);

    // TODO 2.1: Remove the previous call to drawChar and write "Pause"
    drawString(SCREENWIDTH/2 - 15,SCREENHEIGHT/2,"PAUSE",RED);
...
void goToWin() {
    ...
    drawString(SCREENWIDTH/2 - 15,SCREENHEIGHT/2,"WIN",BLACK);
...
void goToLose() {
    ...
    drawString(SCREENWIDTH/2 - 15,SCREENHEIGHT/2,"LOSE",BLACK);
