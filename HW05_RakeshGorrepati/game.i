...
void updateGame() {
    ...
    if (collision(snake.col, snake.row, snake.width, snake.height, apple.col, apple.row, apple.width, apple.height)) {
        ...
        shadowOAM[2].attr1 = apple.col | (0<<14);
        shadowOAM[2].attr2 = ((0)*32+(BLACKBG));
...
void updateSnake() {
    ...
    shadowOAM[0].attr0 = snake.row | (0<<13) | (0<<14);
    shadowOAM[0].attr1 = snake.col | (0<<14);
    shadowOAM[0].attr2 = ((snake.curFrame)*32+(snake.aniState));
    ...
    for (int i = 0; i < 20; i++) {
        ...
        if (snakeArray[i].active) {
            ...
            shadowOAM[i+3].attr0 = snakeArray[i].row | (0<<13) | (0<<14);
            shadowOAM[i+3].attr1 = snakeArray[i].col | (0<<14);
            shadowOAM[i+3].attr2 = ((0)*32+(snakeArray[i].aniState));
            DMANow(3, shadowOAM, ((OBJ_ATTR*)(0x7000000)), 128 * 4);
...
void initializeSnake() {
    ...
    snake.col = 240/2 - (snake.width/2) - 50;
    snake.row = 160/2 - (snake.height/2) - 20;
    snake.width = 8;
    snake.height = 8;
    snake.cdel = 8;
    snake.rdel = 8;
...
void drawApple() {
    ...
    shadowOAM[2].attr0 = apple.row | (0<<13) | (0<<14);
    shadowOAM[2].attr1 = apple.col | (0<<14);
    shadowOAM[2].attr2 = ((0)*32+(apple.aniState));
    DMANow(3, shadowOAM, ((OBJ_ATTR*)(0x7000000)), 128 * 4);
