...
# 1 "pauseScreen.h" 1
# 22 "pauseScreen.h"
extern const unsigned short pauseScreenTiles[1392];
...
void Start(){
 ...
 DMANow(3, bgStartTiles, &((charblock *)0x6000000)[0], 1856/2);
...
void Pause(){
 ...
 DMANow(3, pauseScreenPal, ((unsigned short *)0x5000000), 512/2);
    (*(volatile unsigned short*)0x400000A) = (0<<14) | ((0)<<2) | ((31)<<8);
 DMANow(3, pauseScreenTiles, &((charblock *)0x6000000)[0], 2784/2);
...
void Win(){
 ...
 (*(volatile unsigned short*)0x400000A) = (0<<14) | ((0)<<2) | ((31)<<8);
    DMANow(3, winScreenTiles, &((charblock *)0x6000000)[0], 3328/2);
...
void Lose(){
    ...
    (*(volatile unsigned short*)0x400000A) = (0<<14) | ((0)<<2) | ((31)<<8);
    DMANow(3, loseScreenTiles, &((charblock *)0x6000000)[0], 3936/2);
