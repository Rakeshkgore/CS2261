...
void drawUserRect(int col, int row, int width, int height, unsigned short color);
void drawTargetRect(int col, int row, int width, int height, unsigned short color);
...
void draw() {
 ...
 drawRect(uCol, uRow, uWidth, uHeight, ((0) | (0)<<5 | (31)<<10));
