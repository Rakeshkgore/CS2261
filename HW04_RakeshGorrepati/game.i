...
# 1 "Asteroid.h" 1
# 21 "Asteroid.h"
extern const unsigned short AsteroidBitmap[640];
...
void updateUser(){
    ...
    if(((~((*(volatile unsigned short *)0x04000130)) & ((1<<4)))) || ((!(~(oldButtons)&((1<<4))) && (~buttons & ((1<<4)))))){
    ...
    if(((~((*(volatile unsigned short *)0x04000130)) & ((1<<5)))) || ((!(~(oldButtons)&((1<<5))) && (~buttons & ((1<<5)))))){
    ...
    if(((~((*(volatile unsigned short *)0x04000130)) & ((1<<7)))) || ((!(~(oldButtons)&((1<<7))) && (~buttons & ((1<<7)))))){
    ...
    if(((~((*(volatile unsigned short *)0x04000130)) & ((1<<6)))) || ((!(~(oldButtons)&((1<<6))) && (~buttons & ((1<<6)))))){
...
void updateAsteroid(ASTEROID* a){
    ...
    if( a -> active){
        ...
        if (a->row <= 0 || a->row + a->height-1 >= 160 - 1){

            a->rdel *= -1;

        }
  if (a->col <= 0 || a->col + a->width-1 >= 240 - 1){
