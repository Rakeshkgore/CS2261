...
void Start(){
 ...
 DMANow(3, startTiles, &((charblock *)0x6000000)[0], 3488/2);
...
void Game(){
 unsigned short colors[6] = {((0) | (0)<<5 | (0)<<10), ((0) | (0)<<5 | (31)<<10), ((0) | (31)<<5 | (0)<<10), ((31) | (0)<<5 | (0)<<10), ((31) | (31)<<5 | (31)<<10), ((15) | (15)<<5 | (15)<<10)};
    for (int i = 0; i < 6; i++) {
...
void Instructions(){
 ...
 (*(volatile unsigned short*)0x400000A) = (0<<14) | ((0)<<2) | ((31)<<8);
 DMANow(3, InstructionScreenTiles, &((charblock *)0x6000000)[0], 1760/2);
...
void Lose(){
    ...
    (*(volatile unsigned short*)0x400000A) = (0<<14) | ((0)<<2) | ((31)<<8);
    DMANow(3, loseScreenTiles, &((charblock *)0x6000000)[0], 736/2);
