...
void updateGame() {
    ...
    if (collision(user.col, user.row, user.width, user.height, coin.col, coin.row, coin.width, coin.height)) {
        ...
        shadowOAM[2].attr0 = coin.row | (0<<13) | (0<<14);
        shadowOAM[2].attr1 = coin.col | (0<<14);
...
void updateUser() {
    ...
    shadowOAM[0].attr0 = user.row | (0<<13) | (0<<14);
    shadowOAM[0].attr1 = user.col | (0<<14);
...
void drawCoin() {
    ...
    shadowOAM[2].attr0 = coin.row | (0<<13) | (0<<14);
    shadowOAM[2].attr1 = coin.col | (0<<14);
    shadowOAM[2].attr2 = ((0)*32+(coin.aniState));
    DMANow(3, shadowOAM, ((OBJ_ATTR*)(0x7000000)), 128 * 4);
